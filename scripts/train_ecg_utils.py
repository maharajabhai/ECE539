...
def main():
    ...
    print(f"[Info] Identity meta built with {len(meta)} samples from {meta['patient_id'].nunique()} patients.")
    ...
    # No heart-rate surrogate here; BPM will be evaluated directly in pipelines.
